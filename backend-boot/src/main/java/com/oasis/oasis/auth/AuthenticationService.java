...
import com.oasis.oasis.config.JwtService;
import com.oasis.oasis.exception.EmailAddressNotFoundException;
import com.oasis.oasis.exception.ResourceNotFoundException;
import com.oasis.oasis.token.Token;
import com.oasis.oasis.token.TokenRepository;
import com.oasis.oasis.token.TokenType;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse create(RegisterRequest request) {
    if (repository.existsByEmailAddress(request.getEmailAddress())) {
        throw new EmailAddressNotFoundException("Email address already exists");
    }
